<template>
  <div>
    ...
    <div class="login_info">
      ...
      <input type="text" name="pfp" placeholder="Profile picture link (OPTIONAL)" ref="pfp">
      <input type="text" name="banimg" placeholder="Banner Picture link (OPTIONAL)" ref="banimg">
